...
class LineItWindow(NodeEditorWindow):

    def initUI(self):
        self.name_company = 'wjw'
        self.name_product = 'Line It'
        ...
        self.windowMapper.mappedString.connect(self.setActiveSubWindow)
    ...
    def about(self):
        QMessageBox.about(self, "关于Line It",
                "Line It是一个连线任务工具，可以制作简单的自动化蓝图 "
                "使用PySide6开发， 更多信息可以访问："
                "<a href='https://wjw.today/'>https://wjw.today</a>")
    ...
    def createNodesDock(self):
        self.nodesListWidget = LineItNodesList()
    ...
    def createDetailsDock(self):
        self.detailsDockWidget = LineItDetailsDock()
        self.detailsDockWidget.setMinimumWidth(230)
        self.detailsDock = QDockWidget("Details")
        self.detailsDock.setWidget(self.detailsDockWidget)
    ...
    def createMdiChild(self, child_widget=None):
        nodeeditor = child_widget if child_widget is not None else LineItSubWindow()
        subwnd = self.mdiArea.addSubWindow(nodeeditor)      # mdi窗口特有的api，可以创建一个个的子窗口
        subwnd.setWindowIcon(QIcon(""))
        # nodeeditor.scene.addItemSelectedListener(self.updateEditMenu)
        # nodeeditor.scene.addItemsDeselectedListener(self.updateEditMenu)
        nodeeditor.scene.addItemSelectedListener(lambda : self.updateDetailsDock(nodeeditor.scene.getSelectedItems()))
        nodeeditor.scene.addItemsDeselectedListener(lambda : self.updateDetailsDock(nodeeditor.scene.getSelectedItems()))
